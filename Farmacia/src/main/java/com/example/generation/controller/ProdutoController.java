...
import com.example.generation.repository.CategoriaRepository;
import com.example.generation.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	public ResponseEntity<Object> getByNomeOuLaboratorio(@PathVariable String nome,
	...
	public ResponseEntity<Object> getByNomeELaboratorio(@PathVariable String nome,
			@PathVariable String laboratorio) {
		return ResponseEntity.ok(produtoRepository.findByNomeOrLaboratorio(nome, laboratorio));
	}

	@GetMapping("/preco_inicial/{inicio}/preco_final/{fim}")
	public ResponseEntity<Object> getByPrecoEntreNatve(@PathVariable BigDecimal inicio,
